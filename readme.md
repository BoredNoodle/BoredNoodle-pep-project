...
## [X] 6: Our API should be able to delete a message identified by a message ID.
...
## (WIP) 7: Our API should be able to update a message text identified by a message ID.
...
## [X] 8: Our API should be able to retrieve all messages written by a particular user.
